...
foreach($shopAll as $value){
    ...
    $products->Updateheart($getItemById[0]['name'],$getItemById[0]['manu_id'],$getItemById[0]['type_id'],$getItemById[0]['price'],$getItemById[0]['image'],$getItemById[0]['description'],$getItemById[0]['feature'],$getItemById[0]['Quantity'],$getItemById[0]['BestSellingProducts'],$getItemById[0]['PriceDiscount'],$getItemById[0]['ALL'],$Quantilyshopp,$getItemById[0]['Total'],1,$getItemById[0]['id']);
