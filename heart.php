        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Shopping Heart</span>
                </nav>
            </div>
        </div>
    </div>
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <?php
                            ...
                            $getItemAllshop = $products->getItemAllheart();
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary btn-plus"onclick="window.location.href='kiemtraheartshop.php?id=<?php echo $value['id'] ?>'"><i class="fa fa-shopping-cart"></i></td>
                            <td class="align-middle"><button class="btn btn-sm btn-danger"onclick="window.location.href='deleteheart.php?id=<?php echo $value['id'] ?>'"><i class="fa fa-times"></i></button></td>
                        </tr>
                        <?php endforeach; ?>
