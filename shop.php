...
if (isset($_GET['cate'])) :
    ...
    $getIiemByCate = $products->getItemByCate($cate, $page, $perpage);
 ?>
<body>
    <!-- Topbar Start -->
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Shop <i class="fa fa-angle-down mt-1"></i></a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-dark" href="testindex.php">Home</a>
                    <a class="breadcrumb-item text-dark" href="shop.php?cate=<?php echo $cate?>">Shop</a>
                    <span class="breadcrumb-item active"> <?php echo $manufactures->getcateNamemanufactures($cate)[0]['manu_name']?></span>
                </nav>
            </div>
        </div>
    </div>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href="addshop.php?id=<?php echo $value["id"]?>"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$<?php echo $value['price'] ?>.00</h5><h6 class="text-muted ml-2"><del>$<?php echo $value['Quantity'] ?>.00</del></h6>
                                </div>
