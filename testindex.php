...
$getCatNameByprotypes = $products->getCatNameByprotypes();
...
<body>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="Loginin.php"> <button class="dropdown-item" type="button">Sign in</button></a>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between bg-primary w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    ...
                    $getAllprotypes = $protypes->getAllprotypes();
                    ?>
                    <h6 class="text-dark m-0"><i class="fa fa-bars mr-2"></i> Protypes</h6>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        foreach ($getAllprotypes as $value):
                        ?>
                            <a href="" class="nav-item nav-link"><?php echo $value['type_name']  ?></a>
                        <?php endforeach; ?>
                    </div>
    ...
    <div class="container-fluid mb-3">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <?php
                        $get3NewstItem2 = $products->getNewItem(0, 1);
                        // var_dump($get3NewstItem2);
                        $g = $get3NewstItem2[0]['id'];
                        foreach ($get3NewstItem2 as $value):
                        ?>
                            <div class="carousel-item position-relative active" style="height: 430px;">
                                <img class="position-absolute w-100 h-100" src="AnhDoAn/<?php echo $value['image'] ?>" style="object-fit: cover;">
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div class="p-3" style="max-width: 700px;">
                                        <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown"><?php echo $value['name'] ?></h1>
                                        <p class="mx-md-5 px-5 animate__animated animate__bounceIn"><?php echo $value['description'] ?></p>
                                        <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#45">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        <?php
                        $get3NewstItem1 = $products->getNewItem(1, 2);
                        foreach ($get3NewstItem1 as $value):
                        ?>
            ...
            <div class="col-lg-4">
                <?php
                $get3NewstItem3 = $products->getNewItem(5, 2);
                foreach ($get3NewstItem3 as $value):
                ?>
                    <div class="product-offer mb-30" style="height: 200px;">
                        <img class="img-fluid" src="AnhDoAn/<?php echo $value['image'] ?>" alt="">
                        <div class="offer-text">
                            <h3 class="text-white text-uppercase"><?php echo $value['name'] ?></h6>
                                <h6 class="text-white mb-3"><?php echo $value['description'] ?>
                            </h3>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <?php
            $get3NewstItem3 = $products->getNewItem(4, 8);
            foreach ($get3NewstItem3 as $value):
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <a class="text-decoration-none" href="detailproduct.php?id=<?php echo  $value['id'] ?>">
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <?php
            $get3NewstItem3 = $products->getFeatureNewItem(1, 4);
            foreach ($get3NewstItem3 as $value):
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>$<?php echo $value['price'] ?>.00</h5>
                                <h6 class="text-muted ml-2"><del>$124.00</del></h6>
                            </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="row px-xl-5">
            <?php
            $get3NewstItem4 = $products->getNewItem(10, 2);
            foreach ($get3NewstItem4 as $value):
            ?>
                <div class="col-md-6">
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <?php
            $get3NewstItem5 = $products->getNewItem(9, 4);
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>$<?php echo $value['price'] ?>.00</h5>
                                <h6 class="text-muted ml-2"><del>$<?php echo $value['Quantity'] ?>.00</del></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <?php
            $getAllBestSelling = $products->getAllBestSelling(1, 4);
            foreach ($getAllBestSelling as $value):
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
